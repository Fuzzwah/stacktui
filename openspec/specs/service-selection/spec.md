# Service Selection Specification

## Purpose

Smart service selection logic including auto-selection of affected/unhealthy services and quick-select controls (Changed, Unhealthy, Select All).

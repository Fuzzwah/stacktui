# Container Uptime Specification

## Purpose

Display how long each service container has been running, shown as a compact duration (e.g., "3d 4h") next to the status indicator in the ServicePanel. Helps spot unexpected restarts at a glance.
